    ...
    <div className="flex min-h-80 flex-col gap-3 rounded-2xl p-5 shadow-xl transition-all delay-30 duration-200 ease-in-out hover:-translate-y-1 hover:scale-120 hover:shadow-xl md:w-60 md:shadow-none dark:text-amber-50 dark:shadow-stone-950/50 dark:hover:shadow-stone-950/50">
      ...
      <div className="flex min-w-full flex-col items-center gap-6 md:flex-row md:justify-center md:gap-2">
        ...
        <div className="flex items-center justify-center gap-9 border-stone-600 md:gap-3 md:border-none md:bg-transparent dark:border-stone-400 md:dark:bg-transparent">
          <button
            className="hover:bg-stone flex h-14 w-14 cursor-pointer items-center justify-center rounded-xl bg-indigo-500 p-5 text-5xl transition-all delay-50 duration-200 ease-in-out hover:-translate-y-0.5 hover:scale-110 active:scale-95 md:h-auto md:w-0 md:border-none md:bg-transparent md:p-2 md:text-base dark:border-stone-400"
          ...
          <button
            className="flex h-14 w-14 cursor-pointer items-center justify-center rounded-xl bg-indigo-500 p-5 text-5xl transition-all delay-50 duration-200 ease-in-out hover:-translate-y-0.5 hover:scale-110 active:scale-95 md:w-0 md:border-none md:bg-transparent md:p-2 md:text-base"
